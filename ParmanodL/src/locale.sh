...
docker exec -it ParmanodL /bin/bash -c "chroot /mnt/raspi /bin/bash -c 'raspi-config nonint do_wifi_country US'"
docker exec -it ParmanodL /bin/bash -c "chroot /mnt/raspi /bin/bash -c 'raspi-config nonint do_change_timezone Etc/UTC'"
docker exec -it ParmanodL /bin/bash -c "chroot /mnt/raspi /bin/bash -c 'raspi-config nonint do_configure_keyboard us'"
fi
