...
debug "versions... knotsbitcoin: $knotsbitcoin, knotsmajor: $knotsmajor, core version: $version"
	     ...
	     if [[ $chip == "aarch64" && $OS == "Linux" ]] ; then 				
            ...
            if [[ $( file /bin/bash | cut -d " " -f 3 ) == "64-bit" ]] ; then
                ...
                if [[ $bip110 == "true" ]] ; then
                    curl -fsLO https://github.com/dathonohm/bitcoin/releases/download/v29.2.knots20251110%2Bbip110-v0.1$bip110rc/bitcoin-29.2.knots20251110+bip110-v0.1$bip110rc-aarch64-linux-gnu.tar.gz
                    break
                fi
 	     ...
 	     if [[ $chip == "x86_64" && $OS == "Linux" ]] ; then debug "x86"
                ...
                if [[ $bip110 == "true" ]] ; then
                    curl -fsLO https://github.com/dathonohm/bitcoin/releases/download/v29.2.knots20251110%2Bbip110-v0.1$bip110rc/bitcoin-29.2.knots20251110+bip110-v0.1$bip110rc-x86_64-linux-gnu.tar.gz
                    break
                fi
         ...
         if [[ ($chip == "arm64" && $OS == "Mac") || ( $chip == "aarch64" && $OS == "Mac") ]] ; then debug "arm64 mac"
            ...
            if [[ $bip110 == "true" ]] ; then
                curl -fsLO https://github.com/dathonohm/bitcoin/releases/download/v29.2.knots20251110%2Bbip110-v0.1$bip110rc/bitcoin-29.2.knots20251110+bip110-v0.1$bip110rc-x86_64-apple-darwin.zip
                break
            fi
