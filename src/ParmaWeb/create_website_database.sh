...
sudo mysql -u root -p -e "CREATE DATABASE $website; CREATE USER IF NOT EXISTS \"parmanode\"@'localhost' IDENTIFIED BY \"$password\"; GRANT ALL PRIVILEGES ON $website.* TO \"parmanode\"@\"localhost\"; FLUSH PRIVILEGES;"
}
