...
########################################################################################
   ...
   Parmanode will backup the database to a file called$yello website_database.sql$blue and leave
...
announce_blue "There was an error; you  might have put the wrong password in. Remember,
