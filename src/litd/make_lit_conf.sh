...
lnd.adminmacaroonpath=~/.lnd/data/chain/bitcoin/mainnet/admin.macaroon
lnd.readonlymacaroonpath=~/.lnd/data/chain/bitcoin/mainnet/readonly.macaroon
lnd.invoicemacaroonpath=~/.lnd/data/chain/bitcoin/mainnet/invoice.macaroon
lnd.listen=0.0.0.0:9735
lnd.rpclisten=0.0.0.0:10009
lnd.restlisten=0.0.0.0:8080
lnd.maxpendingchannels=2
; lnd.wallet-unlock-password-file=$customHOME/.lnd/password.txt
