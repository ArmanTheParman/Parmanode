...
file ./parmanode_temp/do_not_delete_move_rename.txt >/dev/null 2>&1 || { echo "Some problem with the download. Aborting. You might wnat to try again later." ; enter_continue ; return 1 ; }
