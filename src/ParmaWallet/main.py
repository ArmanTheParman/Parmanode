...
test_event=Event(pubkey="fad6540c8f2fd2a16a25d0d82dd95d3bad7890d435d1690848a0a77d2883a447", sec=test_secret_bytes, created_at=1718421481, kind=1, content="Why not just make every Tween a Nostr event JSON?")
