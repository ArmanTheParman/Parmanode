...
yesorno "Would you like to remove the Core Lightning data directory at $HOME/.lightning? (This will delete your channels and funds if you haven't closed them.)" && sudo rm -rf $HOME/.lightning
