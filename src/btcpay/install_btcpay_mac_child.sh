...
docker exec -itu parman btcpay bash -l -c "echo 'parmanode' | sudo -S true ; cd /home/parman/parman_programs/parmanode && btcpayinstallsbitcoin="true" ./run_parmanode.sh" || return 1
