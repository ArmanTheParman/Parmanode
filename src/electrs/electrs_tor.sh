...
if sudo grep "HiddenServiceDir /var/lib/tor/electrs-service/" \
    ...
    echo "HiddenServiceDir /var/lib/tor/electrs-service/" | sudo tee -a /etc/tor/torrc >$dn 2>&1
    fi
...
if sudo grep "HiddenServicePort 7004 127.0.0.1:50005" \
    ...
    echo "HiddenServicePort 7004 127.0.0.1:50005" | sudo tee -a /etc/tor/torrc >$dn 2>&1
    fi
