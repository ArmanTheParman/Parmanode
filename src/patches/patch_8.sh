...
if ! file $hp/parman_books/thelinuxcommandlinebook.pdf |& grep -q PDF ; then # FYI, |& pipes bothe std output and std error
pn_tmux "cd $hp/parman_books/ ; git pull" "linux book patch" >$dn
fi
}