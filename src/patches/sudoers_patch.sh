...
$USER ALL=(root) NOPASSWD: $(which systemctl) status bitcoind.service
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status bitcoind
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status tor.service 
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status electrs
#btcpay commands
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status btcpay.service 
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status btcpay
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status socat.service 
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status socat
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status lnd.service 
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status lnd
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status nginx.service 
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status nginx
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status btcrpcexplorer.service 
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status btcrpcexplorer
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status fulcrum.service 
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status fulcrum
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status electrumx.service 
...
$USER ALL=(root) NOPASSWD: $(which systemctl) status electrumx
$USER ALL=(root) NOPASSWD: $(which cp) -f /usr/local/parmanode/electrumx.service /etc/systemd/system/
#i2p commands
$USER ALL=(root) NOPASSWD: $(which systemctl) start i2p.service
$USER ALL=(root) NOPASSWD: $(which systemctl) restart i2p.service
$USER ALL=(root) NOPASSWD: $(which systemctl) stop i2p.service
$USER ALL=(root) NOPASSWD: $(which systemctl) status i2p.service --no-pager
$USER ALL=(root) NOPASSWD: $(which systemctl) start i2p
$USER ALL=(root) NOPASSWD: $(which systemctl) restart i2p
$USER ALL=(root) NOPASSWD: $(which systemctl) stop i2p
$USER ALL=(root) NOPASSWD: $(which systemctl) status i2p --no-pager
#Systemctl commands
