...
install_homebrew 
/opt/homebrew/bin/brew install bash netcat jq vim tmux
enter_continue
...
brew update
brew upgrade
brew install bash netcat jq vim tmux
break
fi
;;
...
sudo apt-get install jq netcat vim net-tools unzip tmux ssh -y 
