...
clear
qbt_version="5.0.1" #need to make sure right file exists in parman.org
...
if [[ $OS == Mac ]] ; then
    ...
    curl -LO https://parman.org/qbittorrent-${qbt_version}.dmg
    ...
    curl -LO https://parman.org/qbittorrent-${qbt_version}_x86_64.AppImage
