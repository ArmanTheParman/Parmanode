...
echo "
; LND conf configuration, message added by Parmanode, from version 3.32.2
...
;
; the tls extra ip setting allows access using an IP address.
; the tls extra domain setting allows access using a domain name.
